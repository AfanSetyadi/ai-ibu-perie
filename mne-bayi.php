        ...
        <main class="main-content">
            ...
            <div id="mneMenuGrid">
                ...
                <div class="link-cards-grid mne-grid">
                    <a href="javascript:void(0)" class="link-card card-gradient-1" data-submenu="registrasi-mne" style="--card-index: 0">
                    ...
                    <a href="javascript:void(0)" class="link-card card-gradient-2" data-submenu="form-skrining-admisi" style="--card-index: 1">
                    ...
                    <a href="javascript:void(0)" class="link-card card-gradient-3" data-submenu="data-skrining-admisi" style="--card-index: 2">
                    ...
                    <a href="javascript:void(0)" class="link-card card-gradient-4" data-submenu="standar-pelayanan" style="--card-index: 3">
                    ...
                    <a href="javascript:void(0)" class="link-card card-gradient-5" data-submenu="penerimaan-rujukan" style="--card-index: 4">
                    ...
                    <a href="javascript:void(0)" class="link-card card-gradient-6" data-submenu="pencatatan-rujukan" style="--card-index: 5">
            ...
            <!-- Form Content Area        -->
            <!-- ======================== -->
            <div id="mneFormArea" style="display: none;">
                <!-- Back Button -->
                ...
                <div class="peristi-content" id="mneContent">
                    ...
                    <div class="form-section-content" id="form-registrasi-mne" style="display: none;">
